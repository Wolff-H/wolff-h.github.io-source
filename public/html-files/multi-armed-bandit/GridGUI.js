GridGUI = function (container) {
    ...
    self.runExperiment = function() {
        ...
        for (let i=1; i <= samples; i++) {
            ...
            let value = self.bandits[selection].getValue();    console.log(value);
    ...
    self.setHTML = function() {
        ...
        self.bannerDiv.innerHTML  = "<b>Multi-Armed Bandit Selection - <a href='http://www.cs.mun.ca/~dchurchill/'>David Churchill</a>";
